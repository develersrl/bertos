...
#if CPU_CM3_STM32F1
#define DEFAULT_SAMPLETIME ADC_SAMPLETIME_239CYCLES5
#else
#define DEFAULT_SAMPLETIME ADC_SAMPLETIME_480CYCLES
#endif
...
void adc_hw_init(void)
{
	...
	adc->SMPR1 |= ((DEFAULT_SAMPLETIME << SMPR1_CH17) |
		(DEFAULT_SAMPLETIME << SMPR1_CH16) |
		(DEFAULT_SAMPLETIME << SMPR1_CH15) |
		(DEFAULT_SAMPLETIME << SMPR1_CH14) |
		(DEFAULT_SAMPLETIME << SMPR1_CH13) |
		(DEFAULT_SAMPLETIME << SMPR1_CH12) |
		(DEFAULT_SAMPLETIME << SMPR1_CH11) |
		(DEFAULT_SAMPLETIME << SMPR1_CH10));

	adc->SMPR2 |= ((DEFAULT_SAMPLETIME << SMPR2_CH9) |
		(DEFAULT_SAMPLETIME << SMPR2_CH8) |
		(DEFAULT_SAMPLETIME << SMPR2_CH7) |
		(DEFAULT_SAMPLETIME << SMPR2_CH6) |
		(DEFAULT_SAMPLETIME << SMPR2_CH5) |
		(DEFAULT_SAMPLETIME << SMPR2_CH4) |
		(DEFAULT_SAMPLETIME << SMPR2_CH3) |
		(DEFAULT_SAMPLETIME << SMPR2_CH2) |
		(DEFAULT_SAMPLETIME << SMPR2_CH1) |
		(DEFAULT_SAMPLETIME << SMPR2_CH0));
